...
HD_PWD='E:/vivado/vivado_lab/ZYNQ/ov5640_lcd7_edge/ov5640_single.runs/system_edge_detector_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_edge_detector_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_edge_detector_0_0.tcl
