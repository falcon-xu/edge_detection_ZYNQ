...
HD_PWD='E:/vivado/vivado_lab/ZYNQ/ov5640_and_lcd7_display/ov5640_single.runs/system_ax_pwm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ax_pwm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ax_pwm_0_0.tcl
