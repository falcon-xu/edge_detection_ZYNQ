...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	AXI_video_strm_V_data_V { axis {  { dst_TDATA out_data 1 24 }  { dst_TREADY out_acc 0 1 } } }
	...
	AXI_video_strm_V_dest_V { axis {  { dst_TVALID out_vld 1 1 }  { dst_TDEST out_data 1 1 } } }
}
