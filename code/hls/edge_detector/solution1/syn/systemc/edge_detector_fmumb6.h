...
// ==============================================================
#ifndef __edge_detector_fmumb6__HH__
#define __edge_detector_fmumb6__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(edge_detector_fmumb6) {
    ...
    SC_CTOR(edge_detector_fmumb6):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
