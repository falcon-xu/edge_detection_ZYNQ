...
// ==============================================================
#ifndef __edge_detector_fpeocq__HH__
#define __edge_detector_fpeocq__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(edge_detector_fpeocq) {
    ...
    SC_CTOR(edge_detector_fpeocq):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
