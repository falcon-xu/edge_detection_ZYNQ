    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(ap_const_lv1_1, exitcond2_fu_200_p2.read()))) {
...
void Mat2AXIvideo::thread_AXI_video_strm_V_data_V_1_ack_out() {
    AXI_video_strm_V_data_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_AXI_video_strm_V_dest_V_1_ack_out() {
    AXI_video_strm_V_dest_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_AXI_video_strm_V_id_V_1_ack_out() {
    AXI_video_strm_V_id_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_AXI_video_strm_V_keep_V_1_ack_out() {
    AXI_video_strm_V_keep_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_AXI_video_strm_V_last_V_1_ack_out() {
    AXI_video_strm_V_last_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_AXI_video_strm_V_strb_V_1_ack_out() {
    AXI_video_strm_V_strb_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_AXI_video_strm_V_user_V_1_ack_out() {
    AXI_video_strm_V_user_V_1_ack_out = dst_TREADY.read();
}
...
void Mat2AXIvideo::thread_dst_TDATA() {
    dst_TDATA = AXI_video_strm_V_data_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
        ...
        dst_TDATA_blk_n = AXI_video_strm_V_data_V_1_state.read()[1];
    } else {
        dst_TDATA_blk_n = ap_const_logic_1;
    }
}

void Mat2AXIvideo::thread_dst_TDEST() {
    dst_TDEST = AXI_video_strm_V_dest_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TID() {
    dst_TID = AXI_video_strm_V_id_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TKEEP() {
    dst_TKEEP = AXI_video_strm_V_keep_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TLAST() {
    dst_TLAST = AXI_video_strm_V_last_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TSTRB() {
    dst_TSTRB = AXI_video_strm_V_strb_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TUSER() {
    dst_TUSER = AXI_video_strm_V_user_V_1_data_out.read();
}

void Mat2AXIvideo::thread_dst_TVALID() {
    dst_TVALID = AXI_video_strm_V_dest_V_1_state.read()[0];
}
